...
<f:form action="advanceOrderPayment.do" method="post" commandName="orders" onkeypress="return event.keyCode!=13">
	...
	<div class="od">
		<div class="odCp">
			<span class="nameaa"><label for="receiverCP"><strong>*</strong>휴대전화번호</label></span>
	...
	<div class="od">
		<c:choose>
			<c:when test="${sessionScope.cstLogin.cstId == null }">
			<div class="odAddress">
				<span class="addressa"><label for="address"><strong>*</strong>주소</label></span>
				...
				<div class="addressaa">
					...
					<div class="addressaaa">
					<input type="button" id="scZipBtn" value="SEARCH"></div>
			...
			<div class="odDetailAddress">
				<span class="odAaa"><label for="detailAddress"><strong>*</strong>상세주소</label></span>
	...
	<div class="od">
		<div class="odDlvWarn">
			<span class="odDlvWarnaa"><label for="dlvwarn">배송시 주의사항</label></span>
