...
public class Orders {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((dlvinfoyn == null) ? 0 : dlvinfoyn.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (dlvEndDate == null) {
			...
			return false;
		if (dlvinfoyn == null) {
			if (other.dlvinfoyn != null)
				return false;
		} else if (!dlvinfoyn.equals(other.dlvinfoyn))
			return false;
		if (dlvwarn == null) {
	...
	public String toString() {
		return "Orders [orderCode=" + orderCode + ", orderDate=" + orderDate
				...
				+ ", dlvinfoyn=" + dlvinfoyn + ", cardCode=" + cardCode
